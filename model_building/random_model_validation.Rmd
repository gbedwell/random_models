...
```{r}
save.image(file = paste0(frag.directory, "/random_model_assessment.RData"), safe = F)
```
...
save.image(file = paste0(frag.directory, "/random_outlier_plot_df.RData"), safe = F)
```
