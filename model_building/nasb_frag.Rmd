...
+ Initial parameter estimates for this fit were hard to guess
...
#### Save the RData file
```{r}
save.image(file = paste0(frag.directory,"/nasb_fragmentation.RData"), safe = F)
```
...
save.image(file = paste0("~/Documents/scripts/bioinformatics/int_sites/int_site_analysis/models/model_files",
                         "/plots_nasb_fragmentation.RData"), safe = F)
```
