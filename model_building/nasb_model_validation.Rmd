...
```{r}
save.image(file = paste0(frag.directory, "/nasb_model_assessment.RData"), safe = F)
```
...
nasb.outliers <- mb.outliers

rm(nasb.outliers)

save.image(file = paste0(frag.directory, "/nasb_outlier_plot_df.RData"), safe = F)
```
