...
```{r, eval=FALSE}
systematic.lower.outliers <- rigrag::pattern_frag_model(df = resampled.unique.genes, pattern="MB") %>%
...
write.table(systematic.lower.outliers, 
            "~/Documents/scripts/bioinformatics/int_sites/int_site_analysis/models/model_files/mb_systematic_rags.txt",
